...
def container_predict(image_file_path, image_key):
    ...
    url = 'http://0.0.0.0:8501/v1/models/cutter_class:predict'
    ...
    #url = 'https://wearclass-jaikwcp3aq-uc.a.run.app:/v1/models/cutter_class:predict'
...
def cutter_class(pic_path, key):
    # send image for inference
    #temp = container_predict(pic_path, key, port_num)
